...
from .views import CreateApplicantView, CreateProjectView, DeleteProjectView, DetailProjectView, ListApplicationsView, UpdateApplicantView, UpdateProjectView
...
urlpatterns = [
    ...
    path('project/applicant/update/<int:pk>/', UpdateApplicantView.as_view(), name='applicant-update'),
